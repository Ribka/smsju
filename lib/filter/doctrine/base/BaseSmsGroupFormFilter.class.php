...
/**
 * SmsGroup filter form base class.
 *
 * @package    sms
 * @subpackage filter
 ...
 */
abstract class BaseSmsGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sms_group_filters[%s]');
